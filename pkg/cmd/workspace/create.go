...
import (
	...
	"github.com/daytonaio/daytona/pkg/logparser"
...
var CreateCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		pendingLog := util.LogEntry{
			Msg: "Request submitted\n",
		}

		logparser.DisplayLogEntry(pendingLog, logparser.WORKSPACE_INDEX)
		...
		go logparser.ReadWorkspaceLogs(activeProfile, id, projectNames, &stopLogs)
